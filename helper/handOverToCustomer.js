...
module.exports = function (email,name,orderNumber,packeges,company,consolidation,billableWeight,total) {
  ...
  transporter.sendMail(
        {
            ...
            subject: `Order #${orderNumber} Handed Over to receiver.`, // Subject line
                                              ...
                                              >
                                                <p style="margin: 0">
                                                  ...
                                                  <span
                                                    ...
                                                    > We're excited to inform you that your recent order 
                                                    #${orderNumber} with ${company} 
                                                    has been successfully Handed over to receiver from Puerto Rico Warehouse .
                                                  </span>
                                                </p>
                                              </div>
                                            </td>
                                          ...
                                          <tr>
                                            <td class="pad">
                                              <div
                                                ...
                                                "
                                              >
                                                <p style="margin: 0">${ricoAddress}</p>
                                              </div>
                                            </td>
                                          </tr>
                                        </table>
