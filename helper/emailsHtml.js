                      ...
                      >
                          ...
                          <tr>
                              ...
                              <p
                                  ...
                                  "
                              >
                              Thank you for registering with us. Please verify your email address to complete your The Shipping Hack registration. Your One Time Password (OTP) is
                              </p>
                              </td>
                          </tr>
                          </tbody>
...
function createBooking(userName, parcelDetails){
  ...
  <div style="font-family: sans-serif">
  <div class="" style="font-size: 12px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #787771; line-height: 1.7;">
  <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;"><span style="font-size:16px; color: rgba(34, 34, 34, 0.6);"> Thank you for placing order at The Shipping Hack Logistica
...
let content =`Thanks for registering with us. Please verify your email address to complete your The Shipping Hack registration. Your One Time Password (OTP) is`
